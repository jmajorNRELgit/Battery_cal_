...
class TIM(tk.Tk):
    ...
    def __init__(self, volts,duration,sleep, initia_sleep, *args, **kwargs):
        ...
        if dry_run == 0:
            ...
            self.power_supply = self.rm.open_resource('GPIB0::1::INSTR')
    ...
    def workerThread1(self):
        ...
        while stop == 0:
            ...
            if dry_run == 0:
                ...
                self.supply_voltage.append(float(self.DAQ.query('MEAS:volt:dc? .01, (@103)')))
                self.cell_voltage.append(float(self.DAQ.query('MEAS:volt:dc? .01, (@104)')))
